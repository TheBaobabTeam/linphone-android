...
\hline
7 &  and Encryption & 13 September 2015 & 27 September 2015 \\
\hline
\end{tabular}
...
\textbf{Description: }We did a review of the six sprint and we discussed our next sprint(sprint seven). We discussed the user stories as well as our roles and what we expected to deliver. \\
...
\begin{enumerate} 
\item I can record a voice note in the group (GUI and Backend).
\item I can send a picture in the group (GUI and Backend).
\item I can record a voice note in the group and send it to the members in the group(GUI and Backend).
